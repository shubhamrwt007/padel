class GetLeagueMatchDetailsModel {
  bool? success;
  HistoryData? history;
  StatisticsData? statistics;

  GetLeagueMatchDetailsModel({this.success, this.history, this.statistics});

  GetLeagueMatchDetailsModel.fromHistoryJson(Map<String, dynamic> json) {
    success = json['success'];
    history = json['data'] != null ? HistoryData.fromJson(json['data']) : null;
  }

  GetLeagueMatchDetailsModel.fromStatisticsJson(Map<String, dynamic> json) {
    success = json['success'];
    statistics =
    json['data'] != null ? StatisticsData.fromJson(json['data']) : null;
  }

  GetLeagueMatchDetailsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
