...
class LiveAndCompleteIptTournamentMatchScreen extends StatefulWidget {
  const LiveAndCompleteIptTournamentMatchScreen({super.key});

  @override
  State<LiveAndCompleteIptTournamentMatchScreen> createState() => _LiveAndCompleteIptTournamentMatchScreenState();
}

class _LiveAndCompleteIptTournamentMatchScreenState extends State<LiveAndCompleteIptTournamentMatchScreen> {
...
class MatchStatsCard extends StatelessWidget {
  final LiveAndCompleteIptTournamentMatchController controller;
...
extension _MatchDetailsUiHelpers on _LiveAndCompleteIptTournamentMatchScreenState {
