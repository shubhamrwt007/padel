...
class LeagueScreen extends StatelessWidget {
    ...
    return Obx(
        ...
        appBar: primaryAppBar(
            ...
            titleTextColor: controller.selectedTab.value == 1
                ? Colors.white
                : Colors.black,
            title: Text("League"),centerTitle: true, context: context,
            // action: [
            //   Container(
          ...
          children: [
            ...
            Expanded(
              child: controller.selectedTab.value == 0
                  ? _liveMatchContent(context).paddingOnly(top: 20)   // your existing live match UI
  ...
  Widget _buildTabs(BuildContext context) {
    return DefaultTabController(
      length: 3,
      initialIndex: 1, // Live tab selected
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
